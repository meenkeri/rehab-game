...
namespace rehabGame
{
    ...
    public class SplashScreen : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //Draw subtext
            spriteBatch.DrawString(secondarySpriteFont, secondaryTextToDraw, new Vector2(Game.Window.ClientBounds.Width / 2 - secondarySpriteFont.MeasureString(secondaryTextToDraw).X / 2, Game.Window.ClientBounds.Height / 2 + TitleSize.Y + 10), Color.Gold);
